...
class Profile(models.Model):
    ...
    adultBaseball = models.BooleanField(default=False, verbose_name="Baseball")
    adultFootball = models.BooleanField(default=False, verbose_name="Football")
    adultSoftball = models.BooleanField(default=False, verbose_name="Softball")
    basketball = models.BooleanField(default=False, verbose_name="Basketball")
