...
def show(request, id):
    ...
    return render(request, 'maps/facilities.html', {'id': id, 'currentFacility': currentFacility, 'track' : track, 'name' : name, 'bocce' : bocce, 'frisbee': frisbee, 'tball': tBall, 'accessible': accessible, 'adultBaseball': adultBaseball, 'adultFootball': adultFootball, 'adultSoftball': adultSoftball, 'description': description, 'basketball': basketball, 'cricket': cricket, 'dimensions': dimensions, 'flagFootball': flagFootball, 'handball': handball, 'hockey' : hockey, 'kickball': kickball, 'lacrosse': lacrosse, 'littleLeagueBaseBallOne': littleLeagueBaseballOne, 'littleLeagueBaseBallTwo': littleLeagueBaseballTwo, 'littleLeagueSoftball': littleLeagueSoftball, 'netball': netball, 'rugby': rugby, 'tennis': tennis, 'volleyball': volleyball, 'wheelchair': wheelchair, 'youthFootball': youthFootball})
